...
def print_creation_statement():
    ...
    from .models import UserAppData, User, ACL, BackupQuestion, PhoneBackupHints, EmailTemplate, BlacklistedEncPhoneNumber, SystemConfig, PushAuthToken,Picture, Transaction
